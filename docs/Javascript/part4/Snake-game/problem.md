...
<body>
  <script>
    //1.可以在自调用函数之前，强行加一个分号，意思是让前面的程序结束
    //2.或者在自调用函数之后，加一个分号。
    ;(function(){
      console.log(1)
    })()
    //前面还有一个返回值，默认为undefined
    ;(function(){
      console.log(2)
    })()
...
1. 把index.js放进[OSCHINA代码压缩](https://tool.oschina.net/jscompress)或者[菜鸟代码压缩](https://c.runoob.com/front-end/51/)进行压缩，加快浏览器加载效率。

<img src="/images/Javascript/object/07.jpg" style="width: 100%; display:inline-block; margin: 0 ;">

2. 复制压缩好的代码放进新建的index.min.js

3. index.html引用 index.min.js
...
- 传入 undefined
  ...
  <img src="/images/Javascript/object/08.jpg" style="width: 100%; display:inline-block; margin: 0 ;">